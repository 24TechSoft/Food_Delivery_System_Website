...
<head>
  ...
  <script>
	...
	function Validate()
	{
		...
		{
			swal("Error","Password must be 8 character long","error'");
			return false;
		}
		else
		{
					        ...
					        <div class="centering">
							    ...
							    <div class="mnn">
									  ...
									  <h3>Please fill up the following to reset your password</h3>
									    ...
									    <div class="bxt">
										<form method="post" action="<?php echo base_url();?>Wallet/ResetPassword?Token=<?php echo $Token;?>&ID=<?php echo $ID;?>" onsubmit="return Validate();">
										  <div class="lttf">
											...
											<div class="extt">
											    ...
											    <table>
													<tr><td><label>New Password: </label></td><td><input type="password" placeholder="New Password" name="NewPassword" id="NewPassword"></td></tr>
