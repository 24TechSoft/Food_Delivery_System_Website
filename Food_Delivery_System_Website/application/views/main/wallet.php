													...
													<tr><td><label></label></td>
													  <td>
														   <div class="smbbrrr">
																...
																<!--button id="myBtn" type="submit" form="nameform" value="Submit">Add Money</button-->
																				  ...
																				  <!--box starts-->
																				     ...
																				     <div class="box">
																					    ...
																					    <table>
																						  ...
																						  <tr><td><label>Amount: </label></td><td><input type="text" placeholder="1000.00" name="Code" id="Code" readonly></td></tr>
													
													                                       <tr><td><label>PayBy: </label></td><td>
										...
										<table id="datatable">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php if($row["EntryType"]==1) echo "Credit"; else echo "Debit"; ?></td>
