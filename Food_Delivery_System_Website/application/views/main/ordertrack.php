					    ...
					    <div class="work">
						   ...
						   <div class="extt-fldd">
							   ...
							   <?php foreach($Orders as $Order)
							   {
								   ?>
							       <div class="boxt">
										<p>Order No:<a href=""><?php echo $Order["ID"];?></a></p>
								       <p>Order Date:<a href=""><?php echo $Order["OrderDate"];?></a></p>
									   <p>Order Time:<a href=""><?php echo $Order["OrderTime"];?></a></p>
									   <!--p>Delivery Time:<a href=""><?php echo $Order["DeliveryTime"];?></a></p-->
								   ...
								   <div class="boxt">
									   ...
									   <p>Full Name:<a href=""><?php echo $Order["FullName"];?></a></p>
									   <p>Address:<a href=""><?php echo $Order["Address"];?></a></p>
								   ...
								   <!--4th box-->
								   <div class="boxt">
										<p>Phone No:<a href=""><?php echo $Order["PhoneNo"];?></a></p>
								       <p>Email:<a href=""><?php echo $Order["Email"];?></a></p>
								       <p>Grand Total:<a href=""><?php echo $Order["GrandTotal"];?></a></p>
...
<script type="text/javascript">
	var counter=setInterval(ShowOrderStatus, 1000);
	$(document).ready(function(){
		ShowStatus();
		ReadCart();
	});
	...
	{
		var url='<?php echo base_url();?>home/GetOrderStatus?OrderID=<?php echo $OrderID;?>';
			$.ajax({
				url:url,
				type:"ajax",
				dataType:'json',
				success:function(data){
					...
					var imm=document.getElementsByClassName("imm")[0];
					var ima=document.getElementsByClassName("ima")[0];
					var mma=document.getElementsByClassName("mma")[0];
					var out=document.getElementsByClassName("jkll")[0];
					var sgn=document.getElementsByClassName("sgn")[0];
					var arr=[imm,ima,mma,out,sgn];
					if(Status==4)
					{
						arr[Status].style.color="#f00";
					}
					else
					{
						arr[Status].style.color="#13f113";
					}
					for(var i=0;i<arr.length;i++)
					{
						if(i!=Status)
						{
							arr[i].style.color="#aaa";
						}
					}
				},
				error:function(){
