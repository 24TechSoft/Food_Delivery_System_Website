      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="clearfix"></div>
			<form method="post" action="<?php echo base_url();?>CouponProduct/AddCouponItem/<?php echo $ID; ?>">
            <div class="row">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-horizontal form-label-left input_mask">
						<div class="form-group">
						   ...
						   <?php
						   foreach($AllProductList as $row)
						   {
						   ?>
						   <div class="checkbox">
							<label>
								<input class="flat" type="checkbox" name="Item[]" id="Item[]" value="<?php echo $row["ID"]; ?>"> <?php echo $row["ItemName"];?><br>
							</label>
						   </div>
						   <?php
						   }
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
						<?php
						foreach($AddedProductList as $row)
						{
						?>
                        <tr>
                              <td><?php echo $row["ItemName"];?></td>
                              <td><a href="<?php echo base_url();?>CouponProduct/DeleteCouponItem/<?php echo $row["CouponID"]."/".$row["ID"];?>">Delete</a></td>
                        </tr>
						<?php
						}
						?>
