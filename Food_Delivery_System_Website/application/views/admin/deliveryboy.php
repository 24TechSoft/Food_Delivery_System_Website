        ...
        <div class="right_col" role="main">
          <div class="">
			...
			if($ID==0)
				{
			?>
			<form name="addDeliveryBoyForm" method="post" action="<?php echo base_url();?>Others/AddDeliveryBoy" enctype="multipart/form-data">
			<?php
				}
				else
				{
			?>
			<form name="addCategoryForm" method="post" action="<?php echo base_url();?>Others/AddDeliveryBoy?ID=<?php echo $ID;?>" enctype="multipart/form-data">
			<?php	
				}
			?>
            <div class="row">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-horizontal form-label-left input_mask">
						<div class="form-group">
							<label>Name : </label>
							<input type="text" placeholder="Name" name="Name" id="Name" value="<?php echo $Name;?>" class="form-control">
						</div>
						<div class="form-group">
							<label>Phone No : </label>
							<input type="text" placeholder="Phone No" name="PhoneNo" id="PhoneNo" value="<?php echo $PhoneNo;?>" class="form-control">
						</div>
					</div>
                  </div>
                </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
						<?php
						foreach($DeliveryBoys as $dlvr)
						{
						?>
                        <tr>
                              <td><?php echo $dlvr["Name"]; ?></td>
                              <td><?php echo $dlvr["PhoneNo"]; ?></td>
							  <td><a href="<?php echo base_url();?>Others/DeleteDeliveryBoy?ID=<?php echo $dlvr["ID"]; ?>" onclick="return confirm('Are you sure?');">Delete</a><br>
							  <a href="<?php echo base_url();?>Others/Deliveryboys?ID=<?php echo $dlvr["ID"]; ?>">Edit</a>
							  </td>
                        </tr>
						<?php
						}
