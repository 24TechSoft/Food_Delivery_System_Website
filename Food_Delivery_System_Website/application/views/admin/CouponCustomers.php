      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="clearfix"></div>
			<form method="post" action="<?php echo base_url();?>CouponCustomers/AddCouponCustomer/<?php echo $ID; ?>/0/25">
            <div class="row">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-horizontal form-label-left input_mask">
						<div class="form-group">
							<label>Coupon Name: </label><label><?php echo $Name;?></label><br>
							<label>Code : </label><label><?php echo $Code;?> </label><br>
							<label>Party: </label><label><?php echo $Party;?></label><br>
							<input type="hidden" value="<?php echo $PartyID;?>" name="PartyID" ID="PartyID"/>
							<label>Validity: </label><br><label><?php echo $ValidFrom." to ".$ValidTo."<br>(".$ValidTimeFrom." to ".$ValidTimeTo.")"; ?></label>
						</div>
					</div>
                  </div>
                </div>
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-horizontal form-label-left input_mask">
						...
						<table id="customers" class="table table-striped table-bordered">
							...
							<tbody>
								<?php
								foreach($AllCustomerList as $row)
								{
								?>
								<tr>
									<td>
									<input class="flat" type="checkbox" name="Customers[]" id="Customers[]" value="<?php echo $row["ID"]; ?>">
									</td>
									<td>
										<?php echo $row["FullName"]."(".$row["MobileNo"].")";?><br>
									</td>
								</tr>
								<?php
								}
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
						<?php
						foreach($AddedCustomerList as $row)
						{
						?>
                        <tr>
                              <td><?php echo $row["FullName"]."(".$row["MobileNo"].")";?></td>
                              <td><a href="<?php echo base_url();?>CouponCustomers/DeleteCouponCustomer/<?php echo $row["CouponID"]."/".$row["ID"];?>">Delete</a></td>
                        </tr>
						<?php
						}
						?>
