        ...
        <div class="right_col" role="main">
          <div class="">
			...
			if($ID==0)
					{
				?>
				<form name="addCategoryForm" method="post" action="<?php echo base_url();?>Menu/AddCategory" enctype="multipart/form-data">
				<?php
					}
					else
					{
				?>
				<form name="addCategoryForm" method="post" action="<?php echo base_url();?>Menu/AddCategory/<?php echo $ID;?>" enctype="multipart/form-data">
				<?php	
					}
				?>
            <div class="row">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-horizontal form-label-left input_mask">
						<div class="form-group">
							...
							<input type="text" placeholder="Serial No" name="SerialNo" id="SerialNo" value="<?php echo $SerialNo;?>" class="form-control" onfocus>
						</div>
						<div class="form-group">
							<label>Name : </label>
							<input type="text" placeholder="Name" name="CName" id="CName" value="<?php echo $CName;?>" class="form-control">
						</div>
						<div class="form-group">
							<label>Description : </label></td>
							<textarea placeholder="Description" name="CDescription" id="CDescription" value="<?php echo $CDescription; ?>" class="form-control"></textarea>
						</div>			   
					</div>
                  </div>
                </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-horizontal form-label-left input_mask">
						...
						<input type="hidden" value="<?php echo $Photo;?>" name="hdPhoto">
						<div class="form-group">
							<?php if($ID!=0){?><img src="<?php echo base_url();?>Uploads/<?php echo $Photo;?>" height="100px"><?php } ?>
						</div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
						...
						?>
                        <tr>
							  <td><?php echo $cat["SerialNo"];?></td>
                              <td><?php echo $cat["CName"]; ?></td>
                              <td><?php echo $cat["CDescription"]; ?></td>
                              <td><img src="<?php echo base_url();?>Uploads/<?php echo $cat["Photo"]; ?>" alt="Image" height="100px" width="150px"></td>
							  <td><a href="<?php echo base_url();?>Menu/DeleteCategory/<?php echo $cat["ID"]; ?>">Delete</a><br>
							  <a href="<?php echo base_url();?>Menu/Category/<?php echo $cat["ID"]; ?>">Edit</a><br>
							  <a href="<?php echo base_url();?>Menu/SubCategory/<?php echo $cat["ID"]; ?>">Add Sub Category</a></td>
                        </tr>
						<?php
						}
						?>
