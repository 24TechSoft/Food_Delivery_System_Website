          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Sub Categories of <?php echo $CategoryName;?></h3>
              </div>
			...
			if($ID==0)
			{
				?><form name="addCategoryForm" method="post" action="<?php echo base_url();?>Menu/AddSubCategory/<?php echo $CategoryID; ?>" enctype="multipart/form-data">
			<?php
			}
			else
			{
				?>
				<form name="addCategoryForm" method="post" action="<?php echo base_url();?>Menu/AddSubCategory/<?php echo $CategoryID; ?>/<?php echo $ID;?>" enctype="multipart/form-data">
				<?php
			}?>
            <div class="row">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-horizontal form-label-left input_mask">
						<div class="form-group">
							...
							<input type="text" placeholder="Name" name="SubCategory" id="SubCategory" value="<?php echo $SubCategory;?>" class="form-control" >
						</div>
					</div>
                  </div>
                </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-horizontal form-label-left input_mask">
						...
						if($ID!=0)
						{
							?><img src="<?php echo base_url();?>Uploads/<?php echo $Photo;?>" height="100px"><?php
						}
						?>
						</div>
                    </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
							  ...
							  <td><a href="<?php echo base_url();?>Menu/DeleteSubCategory/<?php echo $CategoryID;?>/<?php echo $cat["ID"]; ?>">Delete</a><br>
							  <a href="<?php echo base_url();?>Menu/SubCategory/<?php echo $CategoryID;?>/<?php echo $cat["ID"]; ?>">Edit</a></td>
                        </tr>
						<?php
						}
						?>
