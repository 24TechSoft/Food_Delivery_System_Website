      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="clearfix"></div>
			<form action="<?php echo base_url();?>Menu/SaveSpecialMenu/<?php echo sizeof($AddedItems);?>" method="post" enctype="multipart/form-data">
            <div class="row">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-horizontal form-label-left input_mask">
						<div class="form-group">
							<label>Type: </label>
							<select name="EntryType" id="EntryType" class="form-control" onchange="window.location.href = '<?php echo base_url();?>Menu/SpecialMenu/<?php if($EntryType==1){echo "2";}else{echo "1";}?>';">
							<option value="1" <?php if($EntryType==1){echo "selected='selected'";}?> >Hot sellings</option>
							<option value="2" <?php if($EntryType==2){echo "selected='selected'";}?> >Recently Added</option>
							</select>
						</div>
						<div class="form-group">
							<table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
									...
									?>
									<tr>
										<td><input type="checkbox" value="<?php echo $menu["ID"]; ?>" name="MenuID[]"></td>
										<td><?php echo $menu["ItemName"];?></td>
										<td><?php echo $menu["Category"];?>(<?php echo $menu["SubCategory"];?>) </td>
										<td><?php echo $menu["FullPrice"];?></td>
										<td><img src="<?php echo base_url();?>Uploads/<?php echo $menu["Image"];?>" width="100px"></td>
									</tr>
									<?php
									}
									?>
                    ...
                    <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
							...
							<td><img src="<?php echo base_url();?>Uploads/<?php echo $row["Image"];?>" width="100px"></td>
							<td><a href="<?php echo base_url();?>Menu/DeleteSpecialMenu?EntryType=<?php echo $EntryType;?>&ID=<?php echo $row["ID"];?>">Delete</a>
							</td>
                        </tr>
						<?php
						}
