          ...
          <div class="">
			...
			<?php
				if($ID==0)
					{
				?>
				<form name="addDeliveryBoyForm" method="post" action="<?php echo base_url();?>Others/AddArea" enctype="multipart/form-data">
				<?php
					}
					else
					{
				?>
				<form name="addCategoryForm" method="post" action="<?php echo base_url();?>Others/AddArea?ID=<?php echo $ID;?>" enctype="multipart/form-data">
				<?php	
					}
				?>
            <div class="row">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-horizontal form-label-left input_mask">
						<div class="form-group">
							...
							<input type="text" placeholder="Place Name" name="PlaceName" id="PlaceName" value="<?php echo $PlaceName;?>" class="form-control">
						</div>
						
						<div class="form-group">
							<label>Pin Code : </label>
							<input type="text" placeholder="Pin code" name="Pincode" id="Pincode" value="<?php echo $Pincode;?>" class="form-control">
						</div>
						<div class="form-group">
							<label>Min Order Price : </label>
							<input type="text" placeholder="Minimum order price" name="MinOrderPrice" id="MinOrderPrice" value="<?php echo $MinOrderPrice;?>" class="form-control">
						</div>
						<div class="form-group">
							<label>Delivery Charge : </label>
							<input type="text" placeholder="Delivery charge" name="DeliveryCharge" id="DeliveryCharge" value="<?php echo $DeliveryCharge;?>" class="form-control">
						</div>
					</div>
                  </div>
                </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
							  ...
							  <td><?php echo $place["MinOrderPrice"]; ?></td>
                              <td><?php echo $place["DeliveryCharge"]; ?></td>
							  <td><a href="<?php echo base_url();?>Others/DeletePlace?ID=<?php echo $place["ID"]; ?>" onclick="return confirm('Are you sure?');">Delete</a><br>
							  <a href="<?php echo base_url();?>Others/AreaMaster?ID=<?php echo $place["ID"]; ?>">Edit</a>
							  </td>
                        </tr>
						<?php
						}
