  ...
  */
  class datatables
  {
    ...
    */
    ...
    public function setFormatter($func, $index)
    {
      $this->formatter[$index] = $func;
    }
    /**
    ...
    */
    protected function produce_output($charset)
    {
      ...
      foreach($rResult->result_array() as $row_key => $row_val)
      {
        ...
        foreach ($this->formatter as $index => $func) {
            $aaData[$row_key][$index] = $func( $aaData[$row_key][$index]);
        }
      }
